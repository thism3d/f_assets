...
export default function TicketSend() {
  ...
  const sendMutation = trpc.transactions.create.useMutation({
    onSuccess: () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-gray-100 px-4 py-3 flex items-center gap-3 sticky top-0 z-10">
        ...
        <h1 className="text-lg font-semibold text-gray-900">Confirm</h1>
      </div>
      ...
      <div className="px-4 pb-6">
        ...
        <p className="text-sm text-gray-700 mb-4">Select more tickets to send</p>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <label className="text-sm font-medium text-gray-900">
                  Ticket recipient<span className="text-red-500">*</span>
                </label>
                <button className="w-full mt-1 flex items-center justify-between p-3 bg-gray-50 rounded-lg text-left hover:bg-gray-100 transition-colors">
                  <div>
                    <p className="text-sm text-gray-900">
                      {recipientEmail || "Please add the email address of the ticket recipient"}
                    </p>
                  </div>
          ...
          <div className="mb-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <label className="text-sm font-medium text-gray-900">
                  Language to send your ticket(s)
                </label>
                <button
